  ...
  return this.each(function () {
    ...
    if (obj.isShowCover) {
      ...
      $("body")
        ...
        .width($(window).width())
        .height(
          $(window).height() > $(document).height() ? $(window).height() : $(document).height()
        )
        .css({
          position: "fixed",
          _position: "absolute",
    ...
    var resizeFun = function () {
      ...
      $("#mask_div").length > 0 &&
        $("#mask_div")
          ...
          .css({ opacity: "0.6", top: "0px", left: "0px", position: "absolute", zIndex: 999 });
    };
  ...
  $(document).bind("mousemove", function (e) {
    if (ismousedown) {
      ...
      if ("function" == typeof callbackObj.drag) {
        callbackObj.drag(captureEl, diffX - originPos.left, diffY - originPos.top);
      }
      if (diffX < 0) diffX = 0;
      if (diffY < 0) diffY = 0;
    ...
    if (!!cur && !!uin) {
      ...
      if (m.length > 1) {
        if (parseInt(m[1], 10) != parseInt(cur_uin, 10)) {
          qcloud.util.showTips({ type: "info", text: "您的登录态发生变化,3秒后跳转到首页" });
          setTimeout(function () {
    ...
    return $.ajax({
      ...
      success: function (ret) {
        if (ret && ret.retcode == 0) {
          ...
          if (needRelocation == 1) {
            qcloud.util.showTips({ type: "info", text: ret.errmsg + ",5秒后跳转到" + loc });
            setTimeout(function () {
      ...
      function drawLinks() {
        ...
        if (interval[0] > 0 && opts.num_edge_entries > 0) {
          ...
          if (opts.num_edge_entries < interval[0] && opts.ellipse_text) {
            jQuery("<span class='page_nav_m'>" + opts.ellipse_text + "</span>").appendTo(list);
          }
        }
  ...
  var pvSender = {
    ...
    getId: function () {
      ...
      if (t && t.length && t.length > 1) {
        ...
        d =
          (Math.round(Math.random() * 2147483647) * new Date().getUTCMilliseconds()) % 10000000000;
        document.cookie =
          "pgv_pvid=" + d + "; path=/; domain=qq.com; expires=Sun, 18 Jan 2038 00:00:00 GMT;";
      }
...
TCISD.valueStat.config = {
  ...
  defaultParams: { statId: 1, resultType: 1, returnValue: 11, reportRate: 1, duration: 1000 },
  reportAll: false,
};
...
TCISD.hotClick._reportRate =
  typeof TCISD.hotClick._reportRate == "undefined" ? -1 : TCISD.hotClick._reportRate;
...
var qcloud_oz_stat_page_list = {
  "www.qcloud.com": {
    ...
    "/index.php": { ie: [7822, 13, 1], chrome: [7822, 13, 2], firefox: [7822, 13, 3] },
    "/product/product.php": { ie: [7822, 13, 28], chrome: [7822, 13, 29], firefox: [7822, 13, 30] },
  },
  "manage.qcloud.com": {
    "/shoppingcart/shop.php": { ie: [7822, 13, 4], chrome: [7822, 13, 5], firefox: [7822, 13, 6] },
    "/index.php": { ie: [7822, 13, 7], chrome: [7822, 13, 8], firefox: [7822, 13, 9] },
    ...
    "/cvm/CVMList.php": { ie: [7822, 13, 13], chrome: [7822, 13, 14], firefox: [7822, 13, 15] },
    "/cdb_list.php": { ie: [7822, 13, 16], chrome: [7822, 13, 17], firefox: [7822, 13, 18] },
    "/cmem_list.php": { ie: [7822, 13, 19], chrome: [7822, 13, 20], firefox: [7822, 13, 21] },
    "/cdn/cdn_upload.php": { ie: [7822, 13, 22], chrome: [7822, 13, 23], firefox: [7822, 13, 24] },
    "/loadBalance/loadBalanceManage.php": {
      ie: [7822, 13, 25],
      chrome: [7822, 13, 26],
      firefox: [7822, 13, 27],
    },
    "/account/account.php": { ie: [7822, 13, 31], chrome: [7822, 13, 32], firefox: [7822, 13, 33] },
...
$(window).load(function () {
  var pathname = window.location.pathname,
    ...
    bType = !!$.browser.msie
      ? "ie"
      : !!$.browser.webkit && window.navigator.userAgent.toLowerCase().indexOf("chrome") > -1
        ? "chrome"
        : !!$.browser.mozilla
          ? "firefox"
          : "";
  if (
    ...
    if (qcloud_oz_stat_page_list[host].hasOwnProperty(pathname)) {
      setTimeout(function () {
        TCISD.performanceTimeStat(qcloud_oz_stat_page_list[host][pathname][bType]);
      }, 10);
    }
  }
});
...
qcloud.util.htmlEncode = function (str) {
  tmpDiv.textContent != null ? (tmpDiv.textContent = str) : (tmpDiv.innerText = str);
...
qcloud.util.showTips = function (option) {
  ...
  switch (option.type) {
    case "succeed":
      ...
      htmlStrs.push(
        '<span class="gtl_ico_succ"></span>' + option.text + '<span class="gtl_end"></span>'
      );
      break;
    case "error":
      htmlStrs.push(' msgbox_fail">');
      htmlStrs.push(
        '<span class="gtl_ico_fail"></span>' + option.text + '<span class="gtl_end"></span>'
      );
      break;
    case "info":
      htmlStrs.push(' msgbox_hits">');
      htmlStrs.push(
        '<span class="gtl_ico_hits"></span>' + option.text + '<span class="gtl_end"></span>'
      );
      break;
    case "loading":
      htmlStrs.push('">');
...
qcloud.util.addManageCenterHistory = function (name, url) {
  ...
  historyList.push({ url: (url || window.location.href).split("?")[0].split("#")[0], name: name });
  ...
  if (!box.attr("mailinit")) {
    $("<link>")
      .attr({
        ...
        type: "text/css",
        href:
          (CSS_DOMAIN_NEW ? CSS_DOMAIN_NEW : CSS_DOMAIN + "/../proj_qcloud_v2") +
  ...
  if ($cartNum.length && $.cookie("uin") && $.cookie("skey")) {
    $.jsonGetter({
      ...
      sucCb: function (ret) {
        ...
        $cartNum.text("1" == $cartNum.attr("_bracket") ? "（" + num + "）" : num);
      },
      errCb: function (ret) {},
    });
  }
  ...
  $(window).on("resize", function () {
    ...
    timer = setTimeout(function () {
      ...
      if (_top && winHeight / 2 + scrollTop - 70 - 15 < _top) {
        $service.css("margin-top", _top + 15 - winHeight / 2 - scrollTop + "px");
      } else if (_bottom && docHeight < winHeight / 2 + scrollTop - 70 + 15 + elHeight + _bottom) {
        $service.css(
          "margin-top",
...
qcloud.util.queryFlowResult = function (opt) {
  ...
  $.jsonGetter({
    ...
    data: { taskId: taskId, taskType: taskType, moduleId: moduleId, regionId: opt.regionId },
    sucCb: function (ret) {
    ...
    $pa
      ...
      .bind("keydown", function (e) {
        ...
        if (e.which == 13) {
          ...
          this.value = page;
          if (page != current_page && callback && typeof callback == "function") {
            callback(page);
          }
        }
      });
...
qcloud.util.formValidate = (function () {
  ...
  return function (form, vFn, sucFn, errFn, notKeyUp) {
    ...
    if (1 == arguments.length) {
      ...
      vo = { form: form, vFn: vFn, sucFn: sucFn, errFn: errFn, notKeyUp: notKeyUp };
    }
...
qcloud.util.tabView = function (config) {
  ...
  this.tabChangeType = config.tabChangeType && config.tabChangeType == "hover" ? "hover" : "click";
  ...
  this.onMouseEnterTab =
    typeof config.onMouseEnterTab == "function" ? config.onMouseEnterTab : function () {};
  this.onMouseLeaveTab =
    typeof config.onMouseLeaveTab == "function" ? config.onMouseLeaveTab : function () {};
  this.onClickTab = typeof config.onClickTab == "function" ? config.onClickTab : function () {};
  this.beforeChangeTab =
    typeof config.beforeChangeTab == "function" ? config.beforeChangeTab : function () {};
  this.afterChangeTab =
    typeof config.afterChangeTab == "function" ? config.afterChangeTab : function () {};
  this.onTabAutoChange =
    typeof config.onTabAutoChange == "function" ? config.onTabAutoChange : function () {};
...
(function () {
  ...
  $(".ico.sevice_btn").click(function () {
    ...
    $(".sevice_board").animate({ right: 0 }, 1000, function () {
      window.TCISD && window.TCISD.hotClick("right_help.qcloud", "www.qcloud.com");
    });
  });
})();
function clickReport(elem) {
  window.TCISD && window.TCISD.hotClick($(elem).attr("hotrep"), "www.qcloud.com");
  return true;
}
...
$(document).ready(function () {
  ...
  $("#qcloud_project_list")
    .change(function () {
      ...
      $.cookie("projectId", $(this).val(), { path: "/", domain: COOKIE_DOMAIN });
    })
    .val(projectId);
  $("#qcloud_region_list")
    .change(function () {
  ...
  if ($("#qcloud_project_list").length > 0) {
    $.removeCookie("projectId", { path: "/", domain: COOKIE_DOMAIN });
    $.cookie("projectId", $("#qcloud_project_list").val(), { path: "/", domain: COOKIE_DOMAIN });
  }
  if ($("#qcloud_region_list").length > 0) {
    $.removeCookie("regionId", { path: "/", domain: COOKIE_DOMAIN });
    $.cookie("regionId", $("#qcloud_region_list").val(), { path: "/", domain: COOKIE_DOMAIN });
  }
});
